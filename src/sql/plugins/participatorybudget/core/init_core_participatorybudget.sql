...
INSERT INTO core_datastore VALUES ('participatorybudget.site_property.error_vote_user_arrond',"<div class='btn-in-popup'><span id='modal_title'> Vous avez voté pour des projets qui ne sont pas dans votre arrondissement de lieu de vie ou de travail enregistré dans votre profil actuel. Souhaitez-vous maintenant annuler vos votes précédant et voter sur les projets de votre nouvel arrondissement? </span></div>");
INSERT INTO core_datastore VALUES ('participatorybudget.site_property.error_already_voted_tout_paris',"<div class='btn-in-popup'><span id='modal_title'> Vous avez voté sur 10 projets concernant tout Paris. Souhaitez-vous maintenant voter pour les projets par arrondissement ou valider vos votes. </span></div>");
INSERT INTO core_datastore VALUES ('participatorybudget.site_property.error_already_voted_arrondissement',"<div class='btn-in-popup'><span id='modal_title' >Vous avez voté sur 10 projets concernant votre arrondissement. Souhaitez-vous maintenant voter pour les projets de tout Paris ou valider vos votes.  </span></div>");
...
('VOTE_PAR_ARRANDISSEMENT','participatorybudget.adminFeature.VoteParArrand.name',1,'jsp/admin/plugins/participatorybudget/VoteParArrandissement.jsp','participatorybudget.adminFeature.VoteParArrand.description',0,'participatorybudget','SYSTEM',NULL,NULL,21);
